// ============================================================
// Peachtree Roofing — Internal Notes Nightly SMS
...
//
// SETUP:
// 1. Open the Peachtree Roofing Google Sheet
...
//      RC_FROM           → sending number e.g. +17704586405
//
...
//
// 5. The "StaffContacts" sheet should have:
//    Column A: Email, Column B: Phone (e.g. +17705551234)
// ============================================================
...
function getTomorrowET() {
  ...
  var m = String(nowET.getMonth() + 1).padStart(2, '0');
  var d = String(nowET.getDate()).padStart(2, '0');
  return y + '-' + m + '-' + d;
}
